...
export default function MerchantSupportScreen() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: "assistant",
      text:
        "Hi, I am your NONETPAY merchant assistant. Ask me about failed vouchers, pending sync, and weekly collections.",
      meta: null,
    },
  ]);
  ...
  const sendPrompt = async (messageText: string) => {
    ...
    try {
      const data = await fetchMerchantSupportReply(text);
      ...
      Alert.alert("Support Unavailable", error?.message || "Could not reach merchant support right now.");
    } finally {
      setSending(false);
      scrollToBottom();
    }
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            <Text style={styles.title}>Merchant AI Support</Text>
            <Text style={styles.headerSub}>Voucher and settlement help</Text>
          </View>
        ...
        >
          <View style={styles.heroCard}>
            ...
            <Text style={styles.heroTitle}>Resolve failed vouchers and pending sync faster</Text>
            <Text style={styles.heroBody}>
              The assistant checks merchant-side voucher data and recent transactions before answering.
            </Text>
          </View>
              ...
              >
                ...
                {message.meta ? (
                  <View style={styles.metaCard}>
                    <Text style={styles.metaTitle}>Matched voucher</Text>
          ...
          {sending ? (
            <View style={styles.typingRow}>
              <View style={styles.typingBubble}>
                <ActivityIndicator size="small" color="#109669" />
                <Text style={styles.typingText}>Checking merchant voucher data...</Text>
              </View>
            </View>
          ) : null}
        ...
        <View style={styles.inputCard}>
          <TextInput
            ...
            placeholder="Ask about a voucher, payout, or sync issue"
